      ...
      body: _loading
        ...
        : _notifs.isEmpty
          ? const Center(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              Icon(Icons.notifications_none_rounded, size: 60, color: AppColors.textMuted),
              SizedBox(height: 12),
              Text('No notifications', style: TextStyle(fontWeight: FontWeight.w800, color: AppColors.textDark)),
              ...
              itemBuilder: (_, i) {
                ...
                return Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: read ? AppColors.border : AppColors.primary.withOpacity(0.2))),
                  child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Container(width: 36, height: 36,
                      decoration: BoxDecoration(
                        color: AppColors.primary.withOpacity(0.1), borderRadius: BorderRadius.circular(8)),
                      child: Icon(_icon(n['type']?.toString()), color: AppColors.primary, size: 18)),
