...
class _LoginScreenState extends State<LoginScreen> {
  bool isEmail = true, showPassword = false, rememberMe = false;
  final emailCtrl    = TextEditingController();
  final passwordCtrl = TextEditingController();

  @override void dispose() { emailCtrl.dispose(); passwordCtrl.dispose(); super.dispose(); }
    ...
    return Scaffold(
      body: Container(
        ...
        child: SafeArea(child: Center(child: SingleChildScrollView(
          ...
          child: ConstrainedBox(constraints: BoxConstraints(maxWidth: w < 420 ? w : 420),
            child: Column(children: [
              const SizedBox(height: 10),
              Container(width: 72, height: 72,
                decoration: const BoxDecoration(color: Colors.white, shape: BoxShape.circle),
                child: const Icon(Icons.local_hospital_rounded, color: AppColors.primary, size: 34)),
              const SizedBox(height: 14),
              const Text('HealthQueue+', style: TextStyle(color: Colors.white, fontWeight: FontWeight.w800, fontSize: 30)),
              const SizedBox(height: 6),
              Text('AI-Driven Queue Management System', style: TextStyle(color: Colors.white.withOpacity(0.85), fontSize: 14)),
              ...
              Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                  ...
                  const SizedBox(height: 6),
                  const Text('Sign in to access your account', textAlign: TextAlign.center,
                    style: TextStyle(color: AppColors.textMuted)),
                  const SizedBox(height: 16),
                  const Text('Email Address', style: TextStyle(fontWeight: FontWeight.w700)),
                  const SizedBox(height: 8),
                  TextField(controller: emailCtrl, keyboardType: TextInputType.emailAddress,
                    decoration: const InputDecoration(prefixIcon: Icon(Icons.person_outline), hintText: 'juan.delacruz@email.com')),
                  const SizedBox(height: 14),
                  ...
                  TextField(controller: passwordCtrl, obscureText: !showPassword,
                    decoration: InputDecoration(
                      prefixIcon: const Icon(Icons.lock_outline), hintText: 'Enter your password',
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    TextButton(onPressed: () => Navigator.pushNamed(context, AppRoutes.register),
                      child: const Text('Register', style: TextStyle(color: AppColors.primary, fontWeight: FontWeight.w800))),
                  ]),
                ]),
              ),
            ]),
