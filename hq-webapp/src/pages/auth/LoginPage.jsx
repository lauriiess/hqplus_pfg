...
export default function LoginPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // login() returns the user object directly
      ...
      // axios errors come through here — extract the server message
    ...
    <div className={styles.page}>
      <div className={styles.card}>
        ...
        <div className={styles.tabs}>
          <button className={`${styles.tab} ${tab === 'facility' ? styles.tabActive : ''}`} onClick={() => { setTab('facility'); setEmail(''); setPass(''); setError('') }}>
            Facility Admin
          </button>
          <button className={`${styles.tab} ${tab === 'super' ? styles.tabActive : ''}`} onClick={() => { setTab('super'); setEmail(''); setPass(''); setError('') }}>
            Super Admin
          </button>
        </div>
          ...
          <div className="form-group">
            ...
            <div className={styles.inputWrap}>
              ...
              <input
                ...
                placeholder={tab === 'facility' ? 'admin@healthqueue.ph' : 'superadmin@healthqueue.ph'}
